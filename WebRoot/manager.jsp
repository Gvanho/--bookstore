          ...
          <div class="col-md-10">       
            <div id="myTabContent" class="tab-content">
              ...
              <div class="tab-pane fade" id="delete">
                ...
                <% 
                	String sql1 = "select id,name,price,category,pnum from product"; 
              ...
              <div class="tab-pane fade" id="order">
                ...
                <% 
                	String sql2 = "select id,user_id,receiverName,receiverAddress,receiverPhone,ordertime from orders"; 
